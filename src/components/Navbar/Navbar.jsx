...
const Navbar = () => {
  ...
  const link = (
    <>
      <li className="md:text-[10px]  lg:text-[14px]">
        <NavLink to={"/"}>
          {" "}
          <FaHome />
          Home
  ...
  return (
    <div className="navbar  fixed   top-0 mx-auto py-0 min-h-0 z-1  h-18  shadow-sm glass-card bg-[#D9BFA2]">
      <div className="navbar  max-w-11/12   top-0 mx-auto py-0 min-h-0 z-1  h-18  shadow-sm glass-card bg-[#D9BFA2]">
        ...
        <div className="navbar-center hidden md:flex">
          <ul className="menu menu-horizontal px-1  lg:gap-1 sm:ml-10">
            {link}
          </ul>
        </div>
          ...
          {user ? (
            <div className="flex items-center lg:gap-4   ">
              ...
              <div>
                <button
                  onClick={signOutUser}
                  className="btn rounded-full md:text-[10px] md:p-2   lg:text-[14px]  lg:p-6 border-gray-300  btn-sm bg-primary text-white"
                >
                  <IoLogOut /> Logout
                </button>
              </div>
