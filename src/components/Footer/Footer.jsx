  ...
  return (
    <div>
      <footer className="footer  bg-[#D9BFA2] sm:footer-horizontal w-11/12 mx-auto  text-base-content p-10">
        <nav className="md:w-60 lg:w-80  text-primary">
          ...
          <p className="text-primary">
            Your trusted partner in providing premium quality dog food and
            accessories. We're dedicated to keeping your furry friends healthy
            and happy.
          </p>
          ...
          <div className="flex space-x-4 mb-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-600 dark:text-gray-200 hover:text-black"
            >
              <FaXTwitter size={20} />
            </a>
            <a
        ...
        <nav>
          ...
          <div className="flex mt-2 mb-4 justify-center items-center">
            <input
              className="bg-white lg:p-3 p-2 mr-2 w-full rounded-xl"
              type="email"
              name=""
              id=""
              placeholder="Your email"
            />
            <button className="btn rounded-xl md:text-[10px] md:p-2  lg:text-[16px] lg:p-6 border-gray-300  btn-sm bg-primary text-white">
              Subscribe
            </button>
          </div>
      ...
      <aside className="text-center">
        <p className="">
          Copyright © {new Date().getFullYear()} PawMart Learn. All right reserved by 
        </p>
      </aside>
    </div>
  );
